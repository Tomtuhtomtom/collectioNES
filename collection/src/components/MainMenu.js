...
export const MainMenu = ({isLoggedIn, handleLogout, token, handleUserCollections}) => {
            ...
            <div className='main-menu'>
                <ul className='main-menu-list'>
                    {isLoggedIn ? (
                        ...
                        <li className='main-menu-list-item'><Link className='main-menu-link' onClick={() => {handleUserCollections()}} to='/load-collection/'>Load Collection</Link></li>
